// The note heads of a staff (st/components/staff_notes), each drawn as a
// whole note with the accidental the key signature leaves it.
...
export default class WholeNotes extends React.PureComponent {
  ...
  render() {
    let out = this.props.notes.map((n, idx) => this.renderNote(n, idx))
